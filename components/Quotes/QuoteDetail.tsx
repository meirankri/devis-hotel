            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-medium">
                  {format(new Date(quote.checkIn), "dd MMMM", {
                    locale: dateLocale,
                  })}{" "}
                  -{" "}
                  {format(new Date(quote.checkOut), "dd MMMM yyyy", {
                    locale: dateLocale,
                  })}
                </p>
          ...
          {quote.quoteParticipants.map((participant: any) => (
            ...
            >
              ...
              <p className="text-lg font-semibold text-gray-900">
                {participant.count}{" "}
                {participant.count === 1 ? t("person") : t("persons")}
              </p>
            </div>
          ))}
        </div>
          ...
          {totalPrice > 0 && (
            <div className="p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-800">
                {t("pricePerPerson")}:{" "}
                {(totalPrice / totalParticipants).toFixed(2)}€
              </p>
