...
import { Calendar, Users, Mail, Phone, Home, Download } from "lucide-react";
                        ...
                        occupant.count > 0 && (
                          ...
                          >
                            <span className="text-gray-600">
                              {occupant.ageRange.name}
                            </span>
                            <span className="font-medium">
                              {occupant.count}{" "}
                              {t("person", { count: occupant.count })}
                            </span>
                          </div>
                        )
                    )}
                    <div className="pt-2 border-t text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">
                          {qr.quoteRoomOccupants.reduce(
                            (sum: number, o: any) => sum + o.count,
                            0
                          )}{" "}
                          {t("persons")}
                        </span>
